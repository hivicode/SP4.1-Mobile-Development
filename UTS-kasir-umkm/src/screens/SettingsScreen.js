        ...
        >
          ...
          >
            <View style={styles.sectionHeader}>
              <View style={[styles.iconBox, { backgroundColor: previewColors.primarySoft }]}>
                {appearanceMode === 'dark' ? (
                  <Moon size={22} color={previewColors.primary} strokeWidth={2.4} />
                ) : (
                  <Sun size={22} color={previewColors.primary} strokeWidth={2.4} />
                )}
              </View>
              <Text style={[styles.sectionTitle, { color: previewColors.ink }]}>Tampilan</Text>
            </View>
            ...
            <View style={styles.modeRow}>
              ...
              >
                <Text
                  style={[
                    styles.modeText,
                    { color: previewColors.inkMuted },
                    appearanceMode === 'light' && { color: previewColors.primary },
                  ]}
                >
                  Terang
                </Text>
              ...
              >
                <Text
                  style={[
                    styles.modeText,
                    { color: previewColors.inkMuted },
                    appearanceMode === 'dark' && { color: previewColors.primary },
                  ]}
                >
                  Gelap
                </Text>
